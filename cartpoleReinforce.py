...
REINFORCE_OPTIMIZER = optax.adam(5e-2)
...
def run_training_loop(env_name, agent_params, agent_select_action_func,
    ...
    for episode in range(num_episodes):
        ...
        # Reset environment.
        obs = env.reset(seed=0)[0]  # new way to seed the environment
...
save_model_parameters(REINFORCE_params, "./ass2/learned_params.pkl")
save_episode_returns(episode_returns, file_name="./ass2/episode_returns.pkl")
